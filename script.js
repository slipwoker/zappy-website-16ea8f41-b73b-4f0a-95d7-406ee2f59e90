document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
      ...
      fetch(action, {
        ...
        .then(function (response) {
          if (response.ok) {
            ...
            contactForm.reset();
            validatableFields.forEach(function (f) {
    ...
    function showFormMessage(form, message, type) {
      let msgEl = form.querySelector('.form-global-msg');
      if (!msgEl) {
        msgEl = document.createElement('div');
        msgEl.className = 'form-global-msg';
        msgEl.setAttribute('role', 'alert');
        msgEl.setAttribute('aria-live', 'polite');
        form.insertBefore(msgEl, form.firstChild);
      }
      msgEl.textContent = message;
      msgEl.className = 'form-global-msg form-global-msg--' + type;
  ...
  const animatedEls = document.querySelectorAll('.fade-in, .slide-up, .slide-in, [data-animate]');
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "שטיחים לעיצוב הבית משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '16ea8f41-b73b-4f0a-95d7-406ee2f59e90',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '16ea8f41-b73b-4f0a-95d7-406ee2f59e90';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '16ea8f41-b73b-4f0a-95d7-406ee2f59e90';
